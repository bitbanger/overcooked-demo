...
class OvercookedGame(Game):
    ...
    def __init__(self, layouts=["cramped_room"], mdp_params={}, num_players=2, gameTime=30, playerZero='human', playerOne='human', showPotential=False, randomized=False, in_stream=sys.stdin, socketio=None, premove_sender=None, app=None, out_fn=print, chatlog=[], toggle_inp=None, uuid=None, **kwargs):
        self.uuid = uuid
